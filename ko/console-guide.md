...
* 인스턴스 선택: 로드 밸런서(DSR)와 **동일한 서브넷**에 속한 인스턴스만 멤버로 등록할 수 있습니다.
* 접속 포트: 해당 멤버가 트래픽을 수신할 포트 번호를 지정합니다. 멤버별로 서로 다른 포트를 지정할 수 있습니다.
...
* 포트 ID: 멤버 인스턴스의 네트워크 포트 식별자입니다.
* 접속 IP: 멤버 인스턴스의 IP 주소입니다.
* 접속 포트: 멤버가 트래픽을 수신할 포트 번호입니다.
...
2. 각 인스턴스의 **접속 포트**를 입력합니다.
3. **확인** 버튼을 클릭하면 선택한 인스턴스가 멤버로 등록됩니다.
